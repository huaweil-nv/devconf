...
lua <<EOF
    ...
    shell_float = Terminal:new({
        ...
        on_open = function(term)
            vim.cmd("startinsert!")
            vim.api.nvim_buf_set_keymap(term.bufnr, "t", "<C-x>", "<cmd>lua _shell_float_toggle()<CR>", {noremap = true, silent = true})
        end,
    })
...
lua <<EOF
    ...
    function _shell_float_toggle()
        shell_float:toggle()
    end

    vim.api.nvim_set_keymap("n", "<leader>gg", "<cmd>lua _lazygit_toggle()<CR>", {noremap = true, silent = true})
    vim.api.nvim_set_keymap("n", "<C-x>", "<cmd>lua _shell_float_toggle()<CR>", {noremap = true, silent = true})
EOF
